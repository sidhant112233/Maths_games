...
import com.angel.maths_games.databinding.ActivityMulTimerBinding

class Mul_Timer_Activity : AppCompatActivity() {
    private lateinit var binding: ActivityMulTimerBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMulTimerBinding.inflate(layoutInflater)
    ...
    private fun generateAllQuestions() {
        ...
        for (i in 0 until totalQuestions) {
            val num1 = (2..10).random()
            val num2 = (2..10).random()
    ...
    private fun generateOptions(correctAnswer: Int): List<Int> {
        ...
        while (options.size < 4) {
            val deviation = listOf(-12, -6, -3, 3, 6, 12).random()
    ...
    private fun loadQuestion(index: Int) {
        if (index < questions.size) {
            ...
            questionText.text = getString(R.string.what_is_mul, question.num1, question.num2)
    ...
    private fun showFinalScore() {
        ...
        binding.mainGameLayout.visibility = View.GONE
        binding.tryAgainLayout.visibility = View.VISIBLE
        binding.tryAgainMessage.text = "🎉 Multiplication Quiz Completed!\nScore: $score / $totalQuestions"
