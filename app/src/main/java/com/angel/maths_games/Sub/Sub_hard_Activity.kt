...
import com.angel.maths_games.databinding.ActivitySubHard2Binding

class Sub_hard_Activity : AppCompatActivity() {

    private lateinit var binding: ActivitySubHard2Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivitySubHard2Binding.inflate(layoutInflater)
