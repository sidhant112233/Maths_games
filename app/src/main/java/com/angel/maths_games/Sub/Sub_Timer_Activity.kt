...
import com.angel.maths_games.databinding.ActivitySubTimerBinding

class Sub_Timer_Activity : AppCompatActivity() {
    private lateinit var binding: ActivitySubTimerBinding
    ...
    private var timeLeftInMillis: Long = 20000 // 20 seconds per question
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivitySubTimerBinding.inflate(layoutInflater)
        ...
        // Generate all subtraction questions
    ...
    private fun updateTimerText() {
        ...
        val formatted = String.format("%02d", seconds)
        timerText.text = "Time: ${formatted}s"
    }
    ...
    private fun generateAllQuestions() {
        ...
        for (i in 0 until totalQuestions) {
            ...
            val num2 = (1..num1).random() // ensures no negative results
    ...
    private fun loadQuestion(index: Int) {
        if (index < questions.size) {
            ...
            questionText.text = getString(R.string.what_is_sub, question.num1, question.num2)
