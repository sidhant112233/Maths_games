...
import com.angel.maths_games.databinding.ActivityAcivityDuelBinding

class Sub_Duel_Activity : AppCompatActivity() {
    private lateinit var binding: ActivityAcivityDuelBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAcivityDuelBinding.inflate(layoutInflater)
    ...
    // Question Generation - Subtraction
    ...
    private fun generateSubtractionQuestion() {
        ...
        val num2 = (1..num1).random() // ensure result not negative
    ...
    private fun generateOptions(correctAnswer: Int): List<Int> {
        ...
        while (options.size < 4) {
            val deviation = listOf(-10, -8, -6, -4, -2, 2, 4, 6, 8, 10).random()
