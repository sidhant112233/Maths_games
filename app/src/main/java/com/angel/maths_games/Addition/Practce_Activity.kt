   ...
   import com.angel.maths_games.R
    import com.angel.maths_games.databinding.ActivityPractceBinding

    class Practce_Activity : AppCompatActivity() {
        private lateinit var binding: ActivityPractceBinding
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            binding = ActivityPractceBinding.inflate(layoutInflater)
        ...
        private fun generateNewQuestion() {
            ...
            questionText.text = getString(R.string.what_is, num1, num2)
