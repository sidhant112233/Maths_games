...
import com.angel.maths_games.databinding.ActivityDivPracticeBinding

class Div_Practice_Activity : AppCompatActivity() {
    private lateinit var binding: ActivityDivPracticeBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityDivPracticeBinding.inflate(layoutInflater)
    ...
    private fun generateOptions(correctAnswer: Int) {
        ...
        while (options.size < 4) {
            val deviation = listOf(-6, -4, -2, 2, 4, 6).random()
