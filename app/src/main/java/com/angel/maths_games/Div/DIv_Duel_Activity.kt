...
import com.angel.maths_games.databinding.ActivityDivDuelBinding
import com.angel.maths_games.databinding.ActivityDuelBinding

class DIv_Duel_Activity : AppCompatActivity() {
    private lateinit var binding: ActivityDivDuelBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityDivDuelBinding.inflate(layoutInflater)
    ...
    private fun setupClickListeners() {
        ...
        binding.btnExitDuel.setOnClickListener { finish() }
    }
    ...
    private fun generateOptions(correctAnswer: Int): List<Int> {
        ...
        while (options.size < 4) {
            val wrongOption = (1..12).random()
            if (wrongOption != correctAnswer && !options.contains(wrongOption)) {
    ...
    private fun showExitConfirmation() {
        androidx.appcompat.app.AlertDialog.Builder(this)
            .setTitle("Exit Game")
            .setMessage("Are you sure you want to exit the duel? Your progress will be lost.")
