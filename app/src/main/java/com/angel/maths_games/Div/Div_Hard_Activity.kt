...
import com.angel.maths_games.databinding.ActivityDivHardBinding

class Div_Hard_Activity : AppCompatActivity() {

    private lateinit var binding: ActivityDivHardBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityDivHardBinding.inflate(layoutInflater)
    ...
    private fun generateNewQuestion() {
        ...
        val quotient = (2..10).random()
        val dividend = divisor * quotient


        val hideFirst = listOf(true, false).random()

        correctAnswer = if (hideFirst) dividend else divisor
    ...
    private fun generateOptions(correctAnswer: Int) {
        ...
        while (options.size < 4) {
            val deviation = listOf(-4, -3, -2, 2, 3, 4).random()
